...
// public class ArmRaiseCmd extends PIDCommand {
...
//     return (getController().atSetpoint() || armSub.raiseLimitSwitched()); // When the are is at the setpoint OR if the limit switches are hit.
//   }
// }