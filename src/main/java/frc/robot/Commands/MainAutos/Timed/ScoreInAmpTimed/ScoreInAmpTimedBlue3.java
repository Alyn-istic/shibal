...
public class ScoreInAmpTimedBlue3 extends SequentialCommandGroup {
  /** Creates a new AutonomousBackup. */
  public ScoreInAmpTimedBlue3(
    ...
    addCommands(
      ...
      new TankDriveCmd(driveSub, () -> 0.3, () -> 0.3).withTimeout(MoveToAmpTimedConstants.TIME_POS_3),// move forward
