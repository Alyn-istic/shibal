...
public class ScoreInAmpTimedBlue2 extends SequentialCommandGroup {
  /** Creates a new AutonomousBackup. */
  public ScoreInAmpTimedBlue2(
    ...
    addCommands(
      ...
      new TankDriveCmd(driveSub, () -> MoveToAmpTimedConstants.SPEED_TO_AMP, () -> MoveToAmpTimedConstants.SPEED_TO_AMP).withTimeout(MoveToAmpTimedConstants.TIME_POS_2),// move forward
