...
public class Constants {
    ...
    public class ArmConstants {
        ...
        public static final int ticksPerRev = 2048; // The amount of encoder ticks in a full rotation (incorrect)
        public static final double gearRatio = 4; // The gear ratio of the arm (incorrect)
        ...
        public static final int dropLimitSwitchChannel = 2;
